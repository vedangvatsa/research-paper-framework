...
4. \textbf{Hedge Density.} The frequency of cautious words like \textit{may, might, possibly, suggests}.
5. \textbf{Booster Density.} The frequency of confident words like \textit{clearly, demonstrates, establishes}.
6. \textbf{Self-Mention Density.} The frequency of first-person pronouns like \textit{we, our, my}.
7. \textbf{Connector Density.} The frequency of logical transition words like \textit{however, moreover, therefore}.
8. \textbf{Sentence-Opener Connector Ratio.} The proportion of sentences that explicitly start with a transition word, which measures how heavily the writer relies on obvious structural signposts.
...
\textbf{Distributional Analysis.} Table 1 compares human and AI abstracts across the eight extracted features. Six of the eight features show clear statistical differences at the p < 0.001 level, indicating that the two groups of texts have distinct mathematical profiles.
...
\bottomrule
\end{tabular}
\caption{Statistical Comparisons between Human and AI Abstracts (N = 7,604)}
\end{table}
...
\vspace{-0.5em}
\caption{Receiver Operating Characteristic (ROC) curve showing the mean performance across 5-fold cross-validation. The mean AUC of 0.877 indicates strong discriminative power. Individual fold curves (light blue) and the ± 1 standard deviation band demonstrate low variance across folds.}
\end{figure}
...
\vspace{-0.5em}
\caption{Confusion matrix from an 80/20 hold-out split evaluation. The model correctly classifies 615 human abstracts and 617 AI abstracts, with 146 false positives and 143 false negatives, indicating balanced error rates.}
\end{figure}
...
\vspace{-0.5em}
\caption{Random Forest feature importance ranked by Gini impurity decrease. Sentence length CV dominates at 32.0\%, followed by self-mention density (14.3\%) and mean sentence length (14.2\%). The gradient color intensity reflects relative contribution.}
\end{figure}
...
\textbf{Lexical Diversity Findings.} Interestingly, this study found absolutely no statistically significant difference in overall vocabulary variety (measured via MTLD) between human and AI abstracts. This directly challenges the common, intuitive assumption that language models rely on a simpler, more limited, and repetitive vocabulary compared to human experts.
...
\bibitem{ref2}
Hyland, K. (2005). \textit{Metadiscourse on Exploring Interaction in Writing}. London, Continuum.. \href{https://doi.org/10.3138/cmlr.63.3.445}{doi.org/10.3138/cmlr.63.3.445}
...
\bibitem{ref8}
Stribling, J., Krohn, M., \& Aguayo, D. (2005). SCIgen - An Automatic CS Paper Generator. \textit{MIT CSAIL}.. \href{https://scigen.csail.mit.edu}{scigen.csail.mit.edu}
...
\bibitem{ref11}
McCarthy, P. M. (2005). An Assessment of the Range and Usefulness of Lexical Diversity Measures and the Potential of the Measure of Textual, Lexical Diversity (MTLD). \textit{Doctoral dissertation, University of Memphis}.. \href{https://www.memphis.edu/iis/pdfs/mccarthy_dissertation.pdf}{memphis.edu/iis/pdfs/mccarthy\_dissertation.pdf}

\bibitem{ref12}
Chafe, W. (1994). \textit{Discourse, Consciousness, and Time on the Flow and Displacement of Conscious Experience in Speaking and Writing}. Chicago, University of Chicago Press.. \href{https://press.uchicago.edu/ucp/books/book/chicago/D/bo3616656.html}{press.uchicago.edu/ucp/books/book/chicago/D/bo3616656.html}
