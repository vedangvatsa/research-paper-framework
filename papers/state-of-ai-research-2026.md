...
The recency of this corpus (58.8% published from 2023 onward) likely inflates the zero-citation rate, as papers need time to accumulate citations. A separate analysis controlling for publication year would be needed to determine the steady-state zero-citation rate for AI papers.
